...
def get_api_id_and_hash():
    print("mnhthon session pyrogram")
    print("\n---------------------------\n")
    try:
...
def telethon_session():
    ...
    try:
        with TelegramClient(StringSession(), API_ID, API_HASH) as jmthon:
            print("Generating a string session for •mnhthon•")
            try:
                jmthon.send_message(
                    "me",
        ...
        print(er)
        print("If you think It as a Bug, Report to @mnhthon_support\n\n")
